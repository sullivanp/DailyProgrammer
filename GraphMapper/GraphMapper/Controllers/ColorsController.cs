...
namespace GraphMapper.Controllers
{
    public class ColorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Order,Row,Column,Name,Red,Green,Blue")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Row,Column,Order,Name,Red,Green,Blue")] Color color)
        {
            if (ModelState.IsValid)
            {
